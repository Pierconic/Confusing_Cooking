...
import net.mcreator.cookingwithmindthemoods.procedures.EatDinnerProcedure;
import net.mcreator.cookingwithmindthemoods.init.CookingWithMindthemoodsModItems;

public class NibbledSeafoodDinnerPlateBlock extends Block {
	public static final DirectionProperty FACING = HorizontalDirectionalBlock.FACING;

	public NibbledSeafoodDinnerPlateBlock() {
	...
	public ItemStack getCloneItemStack(LevelReader level, BlockPos pos, BlockState state) {
		return new ItemStack(CookingWithMindthemoodsModItems.SEAFOOD_DINNER.get());
	}
	...
	public InteractionResult useWithoutItem(BlockState blockstate, Level world, BlockPos pos, Player entity, BlockHitResult hit) {
		...
		EatDinnerProcedure.execute(world, x, y, z, entity);
