...
public class GlowBerryPlate1Block extends Block {
	public static final DirectionProperty FACING = HorizontalDirectionalBlock.FACING;

	public GlowBerryPlate1Block() {
		super(BlockBehaviour.Properties.of().instrument(NoteBlockInstrument.BASEDRUM).mapColor(MapColor.SNOW)
				...
				.strength(0.1f, 1f).lightLevel(s -> 7).noOcclusion().isRedstoneConductor((bs, br, bp) -> false));
