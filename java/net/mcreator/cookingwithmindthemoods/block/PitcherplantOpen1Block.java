...
import net.mcreator.cookingwithmindthemoods.procedures.PitcherplantEffectProcedure;

public class PitcherplantOpen1Block extends DoublePlantBlock {
	public PitcherplantOpen1Block() {
	...
	public void entityInside(BlockState blockstate, Level world, BlockPos pos, Entity entity) {
		...
		PitcherplantEffectProcedure.execute(world, pos.getX(), pos.getY(), pos.getZ());
	}
}
