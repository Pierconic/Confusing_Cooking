...
import net.mcreator.cookingwithmindthemoods.procedures.BristlesproutSpentRestoreProcedure;

public class BristlesproutSpent2Block extends DoublePlantBlock {
	public BristlesproutSpent2Block() {
	...
	public void randomTick(BlockState blockstate, ServerLevel world, BlockPos pos, RandomSource random) {
		BristlesproutSpentRestoreProcedure.execute(world, pos.getX(), pos.getY(), pos.getZ());
	}
}
