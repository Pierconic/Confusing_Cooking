...
import net.mcreator.cookingwithmindthemoods.procedures.StarCropGrowProcedure;
...
public class StarCrop1Block extends Block {
	public StarCrop1Block() {
	...
	public void randomTick(BlockState blockstate, ServerLevel world, BlockPos pos, RandomSource random) {
		...
		StarCropGrowProcedure.execute(world, pos.getX(), pos.getY(), pos.getZ());
	}
}
