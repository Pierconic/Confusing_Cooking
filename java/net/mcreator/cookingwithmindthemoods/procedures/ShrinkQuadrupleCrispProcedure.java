...
public class ShrinkQuadrupleCrispProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		world.setBlock(BlockPos.containing(x + 0.5, y, z + 0.5), CookingWithMindthemoodsModBlocks.TRIPLE_APPLE_CRISP.get().defaultBlockState(), 3);
		if (world instanceof ServerLevel _level) {
			ItemEntity entityToSpawn = new ItemEntity(_level, x, y, z, new ItemStack(CookingWithMindthemoodsModItems.APPLE_CRISP.get()));
