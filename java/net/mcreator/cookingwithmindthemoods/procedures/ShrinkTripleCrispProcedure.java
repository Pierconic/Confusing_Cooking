...
public class ShrinkTripleCrispProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		...
		if (world instanceof ServerLevel _level) {
			ItemEntity entityToSpawn = new ItemEntity(_level, (x + 0.5), y, (z + 0.5), new ItemStack(CookingWithMindthemoodsModItems.APPLE_CRISP.get()));
