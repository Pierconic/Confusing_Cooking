...
public class WaxingAncientCheeseProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if ((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == Items.HONEYCOMB) {
			...
			world.setBlock(BlockPos.containing(x, y, z), CookingWithMindthemoodsModBlocks.WAXED_ANCIENT_CHEESE_WHEEL.get().defaultBlockState(), 3);
