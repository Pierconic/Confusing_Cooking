...
public class FishTacoRecipeDisplayProcedure {
	public static boolean execute(Entity entity) {
		...
		if ((entity instanceof Player _playerHasItem ? _playerHasItem.getInventory().contains(new ItemStack(CookingWithMindthemoodsModItems.CORN_TORTILLA.get())) : false)
				...
				&& (entity instanceof Player _playerHasItem ? _playerHasItem.getInventory().contains(new ItemStack(Items.COOKED_COD)) : false) && entity.getData(CookingWithMindthemoodsModVariables.PLAYER_VARIABLES).recipebookpage == 7) {
			return true;
		}
		return false;
	}
