...
public class DoubleFishSushiItem extends Item {
	public DoubleFishSushiItem() {
	...
	public ItemStack finishUsingItem(ItemStack itemstack, Level world, LivingEntity entity) {
		ItemStack retval = new ItemStack(CookingWithMindthemoodsModItems.SINGLE_FISH_SUSHI.get());
