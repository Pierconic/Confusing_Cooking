...
public class VeggieSkewerItem extends Item {
	public VeggieSkewerItem() {
		super(new Item.Properties().stacksTo(64).rarity(Rarity.COMMON).food((new FoodProperties.Builder()).nutrition(7).saturationModifier(0.2f).build()));
	}
